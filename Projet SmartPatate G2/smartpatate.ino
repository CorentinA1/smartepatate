...
void setup()
{
  ...
  pinMode(outLaser3,OUTPUT);

  values = new int[width];
  
  setFrequency(375000); //generate a square wave (in this case at 1000Hz)
...
int GetCas()
{
  ...
  if(crete < ((1.89* 1023.0) / 5))
    if(crete < ((0.9 * 1023.0) / 5))
        if(crete < ((0.45 * 1023.0) / 5))
             return 3;
        else 
        return 2;
    else 
